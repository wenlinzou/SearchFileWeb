...
public class TWordCheck {
	private IWordCheckStyle iword;
	
	public TWordCheck(){
		super();
		
	}
	public TWordCheck(IWordCheckStyle iword){
		this.iword = iword;
	}
	...
	//------------------------
	public String drawWordMandomNum(IWordCheckStyle iword) {
