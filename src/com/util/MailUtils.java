...
//			}
	 ...
	 */
 	public static void main(String[] args) {
 		...
 		sendmail.setUserName("lmylay@qq.com");
 		sendmail.setPassWord("Daoxiji2012qq");
 		sendmail.setTo("wenlinzou@qq.com,apollof2@qq.com,wenlinzou@sina.com");
 		sendmail.setFrom("lmylay@qq.com");
		...
		// Mail("dujiang@sricnet.com","du_jiang@sohu.com","smtp.sohu.com","du_jiang","31415926","你好","胃，你好吗？");
 		sendmail.attachfile("f:/hello.php");
 		sendmail.attachfile("f:/mm.zip");
